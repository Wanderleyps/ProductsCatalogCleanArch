...
namespace ProductsCatalogCleanArch.WebUI.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(IProductService productAppService, ICategoryService categoryAppService, IWebHostEnvironment environment)
        {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var image = Path.Combine(wwwroot, "images\\" + productDto.Image);//caminho completo da imagem
